...
const Footer = () => {
  ...
  return (
    <Box as="footer" bg="white" mt={{ base: 8, md: 16 }}>
      {/* Top hairline */}
      <Box maxW="1104px" mx="auto" borderTop="1px solid" borderColor="gray.200" />

      {/* Main footer content */}
      <Box maxW="1200px" mx="auto" px={{ base: 7, md: 12 }} py={{ base: 8, md: 12 }}>
        <Grid
